...
if __name__ == "__main__":
    tree = Searchtree()
    tree.insert_object(5)
    tree.insert_object(6)
    tree.insert_object(1)
    tree.insert_object(4)
    tree.insert_object(8)
    tree.insert_object(7)
    tree.insert_object(2)
    tree.insert_object(10)
    tree.insert_object(-3)
    tree.insert_object(-1)
    tree.print(tree.root)
    print("Size: " + str(tree.size))
    print(tree.contains(10))
    tree.delete_object(-3)
    tree.print(tree.root)
    print("Size: " + str(tree.size))
    tree.delete_tree()
    tree.print(tree.root)
